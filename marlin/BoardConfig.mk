...
VSYNC_EVENT_PHASE_OFFSET_NS := 4000000
SF_VSYNC_EVENT_PHASE_OFFSET_NS := 8000000

DEFAULT_LOW_PERSISTENCE_MODE_BRIGHTNESS := 0x0000005F
...
BOARD_KERNEL_CMDLINE := console=ttyHSL0,115200,n8 androidboot.console=ttyHSL0 androidboot.hardware=marlin user_debug=31 ehci-hcd.park=3 lpm_levels.sleep_disabled=1 cma=16M@0-0xffffffff
