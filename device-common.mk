...
PRODUCT_COPY_FILES += \
    ...
    device/google/marlin/ueventd.common.rc:$(TARGET_COPY_OUT_VENDOR)/etc/ueventd.rc \
...
PRODUCT_COPY_FILES += \
    ...
    prebuilts/vndk/v32/arm64/arch-arm64-armv8-a/shared/vndk-core/libhardware_legacy.so:$(TARGET_COPY_OUT_VENDOR)/lib64/libhardware_legacy.so
