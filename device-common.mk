...
PRODUCT_COPY_FILES += \
    ...
    frameworks/native/data/etc/android.hardware.camera.raw.xml:$(TARGET_COPY_OUT_VENDOR)/etc/permissions/android.hardware.camera.raw.xm
...
# USB
PRODUCT_PACKAGES += \
    android.hardware.usb@1.1-service.marli
